    ...
    render() {
        return (
            <div id={"home"} className={`box ${this.props.focus}`}>
                <div>
                    <span className={"infoButton"} onClick={() => {this.setState({extraInfo: !this.state.extraInfo})}}><i className={`fa fa-${this.state.extraInfo ? "times" : "info"}`}/></span>
                ...
                <div id={"extraInfo"} className={`${this.state.extraInfo ? "show" : ""}`}>
                    ...
                    <h2>Kontakt</h2>
                    <p>Appen är utvecklad ideelt. Har du några problem, förslag på förbättringar eller vill du hjälpa till att programmera så besök gärna open-source projektet <a target={"_blank"} href={"https://github.com/martinlundin/gulafarjan"}>github.com/martinlundin/gulafarjan</a></p>
