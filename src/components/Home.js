        ...
        return (
            <div id={"home"} className={`box ${this.props.focus}`}>
                ...
                <div id={"extraInfo"} className={`${this.state.extraInfo ? "show" : ""}`}>
                    ...
                    <h2>Kontakt</h2>
                    <p>Appen är utvecklat ideelt. Har du några problem, förslag på förbättringar eller vill du hjälpa till att programmera så besök gärna open-source projektet <a href={"https://github.com/martinlundin/gulafarjan"}>github.com/martinlundin/gulafarjan</a></p>
